  ...
  return (
    <div className=" flex bg-neutral-200 min-w-[100vw] min-h-[100vh] justify-center items-center">
      <div className="w-[20rem] flex flex-col gap-2 items-center h-[20rem] bg-white rounded-3xl overflow-hidden shadow-md">
        <h1 className="text-neutral-700 font-semibold text-md">
          Login Process
        </h1>
        <div className="flex flex-col w-[80%]">
          <p className="text-neutral-400 font-medium text-sm">Username</p>
          <input
            className="bg-white border-2 rounded-lg border-teal-600 w-full text-neutral-700 focus:text-neutral-700"
        ...
        <div
          onClick={onSubmit}
          className="bg-teal-600 w-[7rem] py-2 text-center font-medium hover:shadow-md cursor-pointer hover:bg-white rounded-xl text-white hover:text-teal-600"
        >
          LOGIN
        </div>
      </div>
